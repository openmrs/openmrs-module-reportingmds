...
public class EncounterDataDefinitionHandler extends DefinitionHandler<EncounterDataDefinition> {
	 ...
	 */
	@Override
	public Map<Class<? extends EncounterDataDefinition>, String> getTypes() {
		Map<Class<? extends EncounterDataDefinition>, String> map = new HashMap<Class<? extends EncounterDataDefinition>, String>();
		map.put(EncounterDataDefinition.class, "Encounter Data Definition");
		return map;
	}
