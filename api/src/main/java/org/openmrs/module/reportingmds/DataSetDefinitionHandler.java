...
public class DataSetDefinitionHandler extends DefinitionHandler<DataSetDefinition> {
	 ...
	 */
	@Override
	public Map<Class<? extends DataSetDefinition>, String> getTypes() {
		Map<Class<? extends DataSetDefinition>, String> map = new HashMap<Class<? extends DataSetDefinition>, String>();
		map.put(DataSetDefinition.class, "Data Set Definition");
		return map;
	}
